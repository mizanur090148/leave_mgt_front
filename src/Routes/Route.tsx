...
import Dashboard from "../Pages/Dashboard/ProjectDashboard/ProjectDashboard";
import CertificateReport from "../Pages/Dashboard/ProjectDashboard/CertificateReport";
...
import CertificateCreateForm from "../Pages/Forms/Certificates/CreateCertificate";
import CertificateEditForm from "../Pages/Forms/Certificates/EditCertificate";

//import CertificateEditForm from "../Pages/Forms/FormsControl/FormsValidation/FormsValidation";
...
import ViewCertificate from "../Pages/Tables/DataTables/DataSource/ViewCertificate";
...
//import UsersProfile from "../Pages/Application/Profiles/UsersProfile/UsersProfile";
import Profile from "../Pages/Application/Profiles/Profile";

import Unions from "../Pages/Tables/Settings/Unions";
import Users from "../Pages/Tables/Settings/Users";
import Union from "../Pages/Forms/FormsControl/Settings/Union";
import CertificateSettings from "../Pages/Forms/FormsControl/Settings/CertificateSettings";
import User from "../Pages/Forms/FormsControl/Settings/User";
import Balance from "../Pages/Forms/FormsControl/Settings/Balance";
import IncomeEntries from "../Componant/Application/income-entry/IncomeEntries";
import AssetEntries from "../Componant/Application/assets-entry/AssetEntries";
import LiabilitiesEntries from "../Componant/Application/liabilities-entry/LiabilitiesEntries";
import ExpenseEntries from "../Componant/Application/expenses-entry/ExpenseEntries";
import InvestmentCredit from "../Componant/Application/investment-credit-entry/InvestmentCredit";
import TaxReturnSummary from "../Componant/Application/tax-return-summary/TaxReturnSummary";
//import PrintTaxSummary from "../Componant/Application/print-tax-summary/PrintTaxSummary";
import PastReturn from "../Componant/Application/past-returns/PastReturn";
import Settings from "../Componant/Application/Settings/Setting";
import Client from "../Componant/Application/ClientLists/Client";
//import UserCards from "../Pages/Application/Profiles/UserCards/UserCards";
...
const routes = [
  ...
  },
  {
    ...
    Component: <CertificateCreateForm />,
  },
  {
    path: `${process.env.PUBLIC_URL}/certificate/edit`,
    Component: <CertificateEditForm />,
  },
  {
    path: `${process.env.PUBLIC_URL}/certificate/view`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/settings/user/create`,
    Component: <User />,
  },
  {
    path: `${process.env.PUBLIC_URL}/settings/user/balance`,
    Component: <Balance />,
  },
  ...
  // Users
  // {
  //   path: `${process.env.PUBLIC_URL}/user/user_profile`,
