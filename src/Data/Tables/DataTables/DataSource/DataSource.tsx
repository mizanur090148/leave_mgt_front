...
//const Button = (row) => <button type="button">Download</button>;
export const serverColumn: TableColumn<ServerSideProcessingColumnsInterface>[] =
  [
    {
      name: "আবেদনকারীর নাম",
      selector: (row) => row?.details?.applicantName,
      sortable: true,
      center: false,
    },
    {
    ...
    },
    {
      ...
      cell: (row) => (
        <span
          className={`text-danger badge ${
            row.status ? "bg-light-danger" : "bg-light-success"
          }`}
        >
