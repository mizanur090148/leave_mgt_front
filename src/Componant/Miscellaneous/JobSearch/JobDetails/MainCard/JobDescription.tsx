    ...
    <>
      ...
      <div className="job-description">
        ...
        <UL className="simple-list">
          {qualificationData.map((data: any, index: any) => (
      ...
      <div className="job-description">
        ...
        <UL className="simple-list">
          {agencyExpData.map((data: any, index: any) => (
            <LI key={index}>{data}</LI>
          ))}
        </UL>
      </div>
      <div className="job-description">
        ...
        <UL className="simple-list list-styled">
          {perksData.map((data: any, index: any) => (
            <LI key={index}>{data}</LI>
          ))}
        </UL>
      </div>
