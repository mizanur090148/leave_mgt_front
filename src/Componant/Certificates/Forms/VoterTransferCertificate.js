...
const VoterTransferCertificate = ({
  setValue,
  isNid,
  setIsNid,
  isHusband,
      ...
      <Row className="mb-3">
        ...
        <Col md="4" className="position-relative">
          ...
          <ReactDatePicker
            ...
            selected={birthDate}
            onChange={(date) => setValue("details.birthDate", date)}
            dateFormat="dd-MM-yyyy"
          />
      ...
      <Row className="mb-3">
        ...
        <Col md="4" className="position-relative">
          ...
          <Input
            bsSize="sm"
            type="text"
            className={`${errors?.details?.holdingNo ? "is-invalid" : ""}`}
            {...register("details.holdingNo", {})}
            defaultValue={holdingNo}
            onChange={(e) => {
              setValue("details.holdingNo", e.target.value);
            }}
          />
          {errors?.details?.holdingNo && (
            <span className="error-msg">This field is required</span>
          )}
        </Col>
        <Col md="4" className="position-relative"></Col>
      </Row>
      <Row className="mb-3">
        <Col xs="12">
...
export default VoterTransferCertificate;
