...
import { setInquiresForm } from "../../../../../Store/Slices/FormWizardTwoSlice";

const InquiresForm: React.FC<BusinessFormCommonProps> = ({
  callbackActive,
  differentId,
}) => {
  const { inquiresForm } = useSelector((state: any) => state.formWizardTwo);
