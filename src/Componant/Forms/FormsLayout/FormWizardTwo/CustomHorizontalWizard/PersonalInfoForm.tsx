...
import { setPersonalDetailsForm } from "../../../../../Store/Slices/FormWizardTwoSlice";

const PersonalInfoForm: React.FC<BusinessFormCommonProps> = ({
  callbackActive,
}) => {
  const dispatch = useDispatch();
  const { personalDetailsForm } = useSelector(
      ...
      <Row className="g-3">
        ...
        <Col xs="12">
          <FormGroup check>
            ...
            <Label className="mb-0 d-block" for="invalid-check-wizard" check>
              {AgreeToTermsAndConditions}
            </Label>
          </FormGroup>
        </Col>
