        ...
        <Col sm="12">
          <FormGroup>
            ...
            <Field name="state" as="select" className={`form-control ${submitErrors && `${errors.state ? "is-invalid" : "is-valid"}`}`}>
              {validationFormStateList.map((item: any, index: number) => (<option value={item} key={index}>{item}</option>))}
            </Field>
        ...
        <Col sm="12">
          <FormGroup>
            <Field as="select" name="theme" className={`${submitErrors && `${errors.theme ? "is-invalid" : "is-valid"}`}`}>
              ...
              {validationStateList.map((item: any, index: number) => (<option value={item} key={index}>{item}</option>))}
            </Field>
