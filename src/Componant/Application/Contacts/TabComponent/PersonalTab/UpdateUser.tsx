import {
  UpdateUserPropsType,
  UserUpdateType,
} from "../../../../../Types/Application/Contacts";
import { SubmitHandler, useForm } from "react-hook-form";
import { useDispatch } from "react-redux";
import { dynamicImage } from "../../../../../Service";
import { setEditData } from "../../../../../Store/Slices/ContactSlice";
...
const UpdateUser = ({ editData, userEditCallback }: UpdateUserPropsType) => {
  ...
  const UpdateContact: SubmitHandler<UserUpdateType> = (updatedData) => {
    const withImageData = {
      ...updatedData,
      avatar: dynamicImage("user/2.png"),
    };
  ...
  return (
    <div className="contact-editform ps-0 m-auto">
      <Form onSubmit={handleSubmit(UpdateContact)}>
              ...
              <Row>
                ...
                <Col sm="6">
                  <input
                    className="form-control"
                    type="text"
                    defaultValue={editData.sureName}
            ...
            <FormGroup>
              ...
              {errors.email && (
                <span className="text-danger">
                  Please enter email between 18 to 70 year.
                </span>
              )}
            </FormGroup>
          </Col>
        ...
        <Btn color="secondary" className="update-contact me-1">
          {Save}
        </Btn>
        <Btn color="primary" onClick={() => userEditCallback(false, editData)}>
          {Cancel}
        </Btn>
      </Form>
    </div>
