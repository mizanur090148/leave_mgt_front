...
import PastReturnTop from "../../past-returns/components/PastReturnTop";
...
const PartnershipBusiness: React.FC = () => {
  ...
  const getItems = async () => {
    try {
      setLoading(true);
      const res = await getRequest(`partnership-business?past_return=1`);
  ...
  const updateHeadData = (updatedData: any) => {
    ...
    const updatedState = {
      ...
      total: pastReturnTotalData({ ...pastReturnData, partnershipBusiness: result })
    };
                        ...
                        <FormGroup>
                          ...
                          <Input
                            ...
                            {...register(
                              ...
                              {
                                required: "Closing capital is required",
                                onChange: (e) => {
                                  const value = e.target.value;
                                  const updatedLands = [...items];
