...
const NonAgricultureLand: React.FC = () => {
  ...
  const getData = async () => {
    try {
      setLoading(true);
      const res = await getRequest(`agri-non-agri-lands?type=non-agri`);
  ...
  const updateHeadData = (updatedData: any) => {
    ...
    const updatedState = {
      ...assetEntryData,
      nonAgriLand: result,
      total: assetEntryTotalData({ ...assetEntryData, nonAgriLand: result })
    };
  ...
  return (
    <Col xl="9">
      <AssetEntryTop
        title={"Total Non-Agricultural Land"}
                        ...
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              setValue(`items.${key}.property_type_id`, value);
                            }}
                          >
                      ...
                      <Col sm="4" md="4">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            {...register(`items.${key}.cost_of_sale_portion`, {
                              //required: "Location of Property is required",
                              onChange: (e) => {
                                const value = e.target.value;
                                const updatedLands = [...items];
                                updatedLands[key].cost_of_sale_portion = value;
                                setItems(updatedLands);
                                setValue(
                          ...
                          {errors.items?.[key]?.cost_of_sale_portion && (
                            <span className="error-msg">
                              {errors.items[key]?.cost_of_sale_portion?.message}
                            </span>
                          )}
                        </FormGroup>
                      </Col>
