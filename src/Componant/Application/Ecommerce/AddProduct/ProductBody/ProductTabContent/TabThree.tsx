          ...
          <Col xs="12">
            <Row className="gx-xl-3 gx-md-2 gy-md-0 g-2">
              ...
              <Col md="4" sm="6">
                <Input
                  type="number"
                  placeholder={`${ZipCode} (10001)`}
                  name="zipCode"
                  onChange={(e) =>
                    dispatch(
                      setFormValue({ name: "zipCode", value: e.target.value })
                    )
                  }
                />
              </Col>
              <Col md="4" sm="6">
                <Input
                  ...
                  onChange={(e) =>
                    dispatch(
                      setFormValue({ name: "city", value: e.target.value })
                    )
                  }
                />
              </Col>
              <Col md="4">
                <Input
                  ...
                  onChange={(e) =>
                    dispatch(
                      setFormValue({ name: "state", value: e.target.value })
                    )
                  }
                >
                  <option>{"State"}</option>
            ...
            <Row>
              ...
              <Col xs="12">
                <Input
                  ...
                  onChange={(e) =>
                    dispatch(
                      setFormValue({ name: "inputCity", value: e.target.value })
                    )
                  }
                />
                <P className="f-light">
